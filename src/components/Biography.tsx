...
const translations = {
  ...
  ru: {
    ...
    paragraphs: [
      "Татьяна Сенюкова — барбер‑эксперт и основатель образовательных курсов по барберингу и барбершопа «СТАТУСЪ».",
      "Мой путь в профессии начался с работы в крупнейших сетевых барбершопах Москвы. Именно там я отточила навыки на практике и изучила индустрию изнутри — от тонкостей выполнения разных видов стрижек до нюансов взаимодействия с клиентами.",
