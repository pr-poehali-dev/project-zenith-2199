...
const translations = {
  ...
  ru: {
    ...
    paragraphs: [
      "Татьяна Сенюкова — барбер‑эксперт, основатель образовательных курсов по барберингу.",
      "Мой путь в профессии начался с работы в сетевых барбершопах Москвы. Именно там я отточила навыки на практике и изучила индустрию изнутри — от тонкостей выполнения разных видов стрижек до нюансов взаимодействия с клиентами.",
